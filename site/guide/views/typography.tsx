import {VMenuLink} from 'orion/ui/helpers';
    ...
    sidebar() {
        return (
            <div className="l-vmenu">
                ...
                <VMenuLink hash="#fonts">Fonts</VMenuLink>
                <VMenuLink hash="#headings">Headings</VMenuLink>
                <VMenuLink hash="#paragraphs">Paragraphs</VMenuLink>
